...
public class NoSubInterceptorWrapper implements StatementInterceptorV2 {
    ...
    public NoSubInterceptorWrapper(StatementInterceptorV2 underlyingInterceptor2) {
        if (underlyingInterceptor2 != null) {
            this.underlyingInterceptor = underlyingInterceptor2;
            return;
        }
