...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00a5, code lost:
        if (r4 == kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE) goto L_0x00c0;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00bc, code lost:
        if (r2.emit(r4, r8) != r1) goto L_0x00bf;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00cf, code lost:
        if (r3.awaitValue(r7, r8) != r1) goto L_0x009e;
     */
    ...
    static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl r6, kotlinx.coroutines.flow.FlowCollector r7, kotlin.coroutines.Continuation r8) {
        ...
        L_0x002d:
            ...
            kotlin.ResultKt.throwOnFailure(r0)     // Catch:{ all -> 0x00d3 }
            goto L_0x00bf
        L_0x0042:
            java.lang.Object r6 = r8.L$3
            kotlinx.coroutines.Job r6 = (kotlinx.coroutines.Job) r6
        ...
        L_0x006a:
            ...
            r7 = r6
            kotlinx.coroutines.flow.SharedFlowSlot r7 = (kotlinx.coroutines.flow.SharedFlowSlot) r7
            boolean r6 = r2 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00d3 }
            if (r6 == 0) goto L_0x008e
            r6 = r2
            kotlinx.coroutines.flow.SubscribedFlowCollector r6 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r6     // Catch:{ all -> 0x00d3 }
            r8.L$0 = r3     // Catch:{ all -> 0x00d3 }
            r8.L$1 = r2     // Catch:{ all -> 0x00d3 }
            r8.L$2 = r7     // Catch:{ all -> 0x00d3 }
            r4 = 1
            r8.label = r4     // Catch:{ all -> 0x00d3 }
            java.lang.Object r6 = r6.onSubscription(r8)     // Catch:{ all -> 0x00d3 }
            if (r6 != r1) goto L_0x008e
            return r1
        L_0x008e:
            r6 = 0
            kotlin.coroutines.CoroutineContext r4 = r8.getContext()     // Catch:{ all -> 0x00d3 }
            kotlinx.coroutines.Job$Key r6 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00d3 }
            kotlin.coroutines.CoroutineContext$Key r6 = (kotlin.coroutines.CoroutineContext.Key) r6     // Catch:{ all -> 0x00d3 }
            kotlin.coroutines.CoroutineContext$Element r6 = r4.get(r6)     // Catch:{ all -> 0x00d3 }
            kotlinx.coroutines.Job r6 = (kotlinx.coroutines.Job) r6     // Catch:{ all -> 0x00d3 }
        L_0x009d:
        L_0x009e:
            java.lang.Object r4 = r3.tryTakeValue(r7)     // Catch:{ all -> 0x00d3 }
            kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE     // Catch:{ all -> 0x00d3 }
            if (r4 == r5) goto L_0x00c0
            if (r6 != 0) goto L_0x00aa
            goto L_0x00ad
        L_0x00aa:
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r6)     // Catch:{ all -> 0x00d3 }
        L_0x00ad:
            r8.L$0 = r3     // Catch:{ all -> 0x00d3 }
            r8.L$1 = r2     // Catch:{ all -> 0x00d3 }
            r8.L$2 = r7     // Catch:{ all -> 0x00d3 }
            r8.L$3 = r6     // Catch:{ all -> 0x00d3 }
            r5 = 3
            r8.label = r5     // Catch:{ all -> 0x00d3 }
            java.lang.Object r5 = r2.emit(r4, r8)     // Catch:{ all -> 0x00d3 }
        ...
        L_0x00c0:
            ...
            r4 = 2
            r8.label = r4     // Catch:{ all -> 0x00d3 }
            java.lang.Object r4 = r3.awaitValue(r7, r8)     // Catch:{ all -> 0x00d3 }
    ...
    public boolean tryEmit(T value) {
        ...
        while (i < length) {
            ...
            if (cont != null) {
                ...
                cont.resumeWith(Result.m173constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T value, Continuation<? super Unit> $completion) {
        ...
        while (i < length) {
            ...
            if (r != null) {
                ...
                r.resumeWith(Result.m173constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        while (i < length) {
            ...
            if (resume != null) {
                Result.Companion companion = Result.Companion;
                resume.resumeWith(Result.m173constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
