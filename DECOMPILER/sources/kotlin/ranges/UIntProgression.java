...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1384getProgressionLastElementNkh28Cs(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m312toStringimpl(this.first)).append("..").append(UInt.m312toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m312toStringimpl(this.first)).append(" downTo ").append(UInt.m312toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
