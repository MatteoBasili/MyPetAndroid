...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state, new State(((State) state).value, addSubscriber(((State) state).subscribers, subscriber))));
        return subscriber;
    }
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state, new State(obj, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state, cause == null ? CLOSED : new Closed(cause)));
    ...
    public Object m1687trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it == null) {
            return ChannelResult.Companion.m1686successJP2dKIU(Unit.INSTANCE);
        }
        return ChannelResult.Companion.m1684closedJP2dKIU(it.getSendException());
    }
    ...
    private final kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed offerInternal(E r14) {
        ...
        L_0x000f:
            ...
            r2 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Closed r2 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed) r2     // Catch:{ all -> 0x0061 }
        L_0x001b:
            r13._updating = r1
            return r2
        L_0x001e:
            ...
            boolean r7 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r7, r13, r4, r6)     // Catch:{ all -> 0x0061 }
        ...
        L_0x0051:
            ...
            java.lang.String r2 = kotlin.jvm.internal.Intrinsics.stringPlus(r2, r4)     // Catch:{ all -> 0x0061 }
