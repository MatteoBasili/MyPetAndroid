...
public class JDBC4CallableStatement extends CallableStatement {
    ...
    public ResultSet getParamTypes(String catalog, String routineName) throws SQLException {
        ...
        if (this.callingStoredFunction) {
            return dbmd.getFunctionColumns(catalog, (String) null, routineName, "%");
        }
        ...
        try {
            ...
            return dbmd.getProcedureColumns(catalog, (String) null, routineName, "%");
        } finally {
    ...
    public void setNClob(String parameterName, NClob value) throws SQLException {
        JDBC4PreparedStatementHelper.setNClob((PreparedStatement) this, getNamedParamIndex(parameterName, false), value);
    }
