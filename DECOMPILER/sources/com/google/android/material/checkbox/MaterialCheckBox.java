...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public /* synthetic */ void m148lambda$new$0$comgoogleandroidmaterialcheckboxMaterialCheckBox() {
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray attributes) {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            if (buttonResourceId == R.drawable.abc_btn_check_material && buttonCompatResourceId == R.drawable.abc_btn_check_material_anim) {
                return true;
            }
            return false;
