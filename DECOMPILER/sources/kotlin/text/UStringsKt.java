...
public final class UStringsKt {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m240unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m500unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m318unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m396unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m318unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m267constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m185boximpl(UByte.m191constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m318unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m267constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m445boximpl(UShort.m451constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m267constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m520uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m267constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m267constructorimpl(UInt.m267constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m261boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m345constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m522ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m345constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m345constructorimpl(ULong.m345constructorimpl(((long) UInt.m267constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m339boximpl(result);
    }
}
