...
public final class ToolbarWithBackBinding implements ViewBinding {
  ...
  private ToolbarWithBackBinding(@NonNull RelativeLayout rootView, @NonNull ImageView backArrow,
  ...
  @NonNull
  public static ToolbarWithBackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToolbarWithBackBinding((RelativeLayout) rootView, backArrow, toolbarTitle);
    }
