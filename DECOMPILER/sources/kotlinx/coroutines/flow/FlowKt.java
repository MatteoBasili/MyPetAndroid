...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m77catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m84catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m78debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt__DelayKt.m80debounceHG0u8IE($this$debounce, timeout);
    }
    ...
    public static final <T> Flow<T> m79sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt__DelayKt.m81sampleHG0u8IE($this$sample, period);
    }
