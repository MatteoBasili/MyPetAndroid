...
public class ConnectionGroup {
    ...
    ConnectionGroup(String groupName2) {
    ...
    public synchronized void removeHost(String hostPortPair, boolean removeExisting, boolean waitForGracefulFailover) throws SQLException {
        if (this.activeHosts == 1) {
            throw SQLError.createSQLException("Cannot remove host, only one configured host active.", (ExceptionInterceptor) null);
            ...
            throw SQLError.createSQLException("Host is not configured: " + hostPortPair, (ExceptionInterceptor) null);
        }
    }
