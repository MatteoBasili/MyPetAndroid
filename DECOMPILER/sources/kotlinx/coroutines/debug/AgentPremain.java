...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m173constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m173constructorimpl(ResultKt.createFailure(th));
        }
        if (!Result.m179isFailureimpl(obj)) {
            bool = obj;
        }
        Boolean bool2 = bool;
        if (bool2 == null) {
    ...
    public static final void m1694installSignalHandler$lambda1(Signal it) {
