...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected() != 0) {
            while (true) {
                ...
                if (result$iv == SelectKt.UNDECIDED) {
                    ...
                    if (Result.m179isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable exception$iv = Result.m176exceptionOrNullimpl(result);
                        ...
                        continuation.resumeWith(Result.m173constructorimpl(ResultKt.createFailure(th)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected() != 0) {
            while (true) {
                ...
                if (result$iv == SelectKt.UNDECIDED) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.UNDECIDED, new CompletedExceptionally(th, false, 2, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else if (result$iv != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m173constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        } else {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            Result.Companion companion = Result.Companion;
            resumeWith(Result.m173constructorimpl(ResultKt.createFailure(e)));
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            if (affected != null) {
                ...
                AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, impl, this, decision == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return decision;
            }
    ...
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final void completeSelect(Object failure) {
            ...
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, this.impl, this, selectSuccess ? null : SelectKt.getNOT_SELECTED()) && selectSuccess) {
