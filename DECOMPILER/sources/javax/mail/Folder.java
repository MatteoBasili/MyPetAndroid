...
public abstract class Folder {
    ...
    public synchronized void setFlags(int r3, int r4, javax.mail.Flags r5, boolean r6) throws javax.mail.MessagingException {
        ...
        L_0x0002:
            ...
            return
        L_0x0006:
            javax.mail.Message r1 = r2.getMessage(r0)     // Catch:{ MessageRemovedException -> 0x0011, all -> 0x000e }
            r1.setFlags(r5, r6)     // Catch:{ MessageRemovedException -> 0x0011, all -> 0x000e }
            goto L_0x0012
        L_0x000e:
            r3 = move-exception
            monitor-exit(r2)
