...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context baseContext) {
        ...
        if (sCanApplyOverrideConfiguration && (baseContext instanceof ContextThemeWrapper)) {
            try {
                ContextThemeWrapperCompatApi17Impl.applyOverrideConfiguration((ContextThemeWrapper) baseContext, createOverrideConfigurationForDayNight(baseContext, modeToApply, (Configuration) null, false));
                return baseContext;
        ...
        if (baseContext instanceof androidx.appcompat.view.ContextThemeWrapper) {
            try {
                ((androidx.appcompat.view.ContextThemeWrapper) baseContext).applyOverrideConfiguration(createOverrideConfigurationForDayNight(baseContext, modeToApply, (Configuration) null, false));
                return baseContext;
        ...
        Configuration overrideConfig2 = createOverrideConfigurationForDayNight(baseContext, modeToApply, configOverlay, true);
    ...
    private boolean updateForNightMode(int mode, boolean allowRecreation) {
        boolean handled = false;
        Configuration overrideConfig = createOverrideConfigurationForDayNight(this.mContext, mode, (Configuration) null, false);
