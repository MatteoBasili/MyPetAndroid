...
public class FabricMySQLConnectionProxy extends ConnectionPropertiesImpl implements FabricMySQLConnection, FabricMySQLConnectionProperties {
    ...
    public FabricMySQLConnectionProxy(Properties props) throws SQLException {
        ...
        if (this.fabricServerGroup == null || this.fabricShardTable == null) {
            try {
                ...
                this.log = LogFactory.getLogger(getLogger(), "FabricMySQLConnectionProxy", (ExceptionInterceptor) null);
                setShardTable(this.fabricShardTable);
                setShardKey(this.fabricShardKey);
                setServerGroupName(this.fabricServerGroup);
            } catch (FabricCommunicationException ex) {
                throw SQLError.createSQLException("Unable to establish connection to the Fabric server", SQLError.SQL_STATE_CONNECTION_REJECTED, (Throwable) ex, getExceptionInterceptor(), (Connection) this);
            }
        } else {
            throw SQLError.createSQLException("Server group and shard table are mutually exclusive. Only one may be provided.", SQLError.SQL_STATE_CONNECTION_REJECTED, (Throwable) null, getExceptionInterceptor(), (Connection) this);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:?, code lost:
        replConnGroupLocks.remove(r5.serverGroup.getName());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x00df, code lost:
        throw r1;
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:31:0x0096, B:46:0x00c3] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized java.sql.SQLException interceptException(java.sql.SQLException r6, com.mysql.jdbc.Connection r7, java.lang.String r8, java.lang.String r9, java.lang.String r10) throws com.mysql.fabric.FabricCommunicationException {
        /*
            r5 = this;
            monitor-enter(r5)
            java.lang.String r0 = r6.getSQLState()     // Catch:{ all -> 0x00ea }
            r1 = 0
            if (r0 == 0) goto L_0x0014
            java.lang.String r0 = r6.getSQLState()     // Catch:{ all -> 0x00ea }
            java.lang.String r2 = "08"
            boolean r0 = r0.startsWith(r2)     // Catch:{ all -> 0x00ea }
            if (r0 != 0) goto L_0x002e
        L_0x0014:
            java.lang.Class<com.mysql.jdbc.exceptions.MySQLNonTransientConnectionException> r0 = com.mysql.jdbc.exceptions.MySQLNonTransientConnectionException.class
            java.lang.Class r2 = r6.getClass()     // Catch:{ all -> 0x00ea }
            boolean r0 = r0.isAssignableFrom(r2)     // Catch:{ all -> 0x00ea }
            if (r0 != 0) goto L_0x002e
            java.lang.Class<?> r0 = JDBC4_NON_TRANSIENT_CONN_EXCEPTION     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x0044
            java.lang.Class r2 = r6.getClass()     // Catch:{ all -> 0x00ea }
            boolean r0 = r0.isAssignableFrom(r2)     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x0044
        L_0x002e:
            java.lang.Throwable r0 = r6.getCause()     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x0046
            java.lang.Class<com.mysql.fabric.FabricCommunicationException> r0 = com.mysql.fabric.FabricCommunicationException.class
            java.lang.Throwable r2 = r6.getCause()     // Catch:{ all -> 0x00ea }
            java.lang.Class r2 = r2.getClass()     // Catch:{ all -> 0x00ea }
            boolean r0 = r0.isAssignableFrom(r2)     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x0046
        L_0x0044:
            monitor-exit(r5)
            return r1
        L_0x0046:
            com.mysql.fabric.ServerGroup r0 = r5.serverGroup     // Catch:{ all -> 0x00ea }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ea }
            r2.<init>()     // Catch:{ all -> 0x00ea }
            java.lang.StringBuilder r2 = r2.append(r9)     // Catch:{ all -> 0x00ea }
            java.lang.String r3 = ":"
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00ea }
            java.lang.StringBuilder r2 = r2.append(r10)     // Catch:{ all -> 0x00ea }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x00ea }
            com.mysql.fabric.Server r0 = r0.getServer(r2)     // Catch:{ all -> 0x00ea }
            if (r0 != 0) goto L_0x0067
            monitor-exit(r5)
            return r1
        L_0x0067:
            boolean r2 = r5.reportErrors     // Catch:{ all -> 0x00ea }
            if (r2 == 0) goto L_0x0079
            com.mysql.fabric.FabricConnection r2 = r5.fabricConnection     // Catch:{ all -> 0x00ea }
            com.mysql.fabric.proto.xmlrpc.XmlRpcClient r2 = r2.getClient()     // Catch:{ all -> 0x00ea }
            java.lang.String r3 = r6.toString()     // Catch:{ all -> 0x00ea }
            r4 = 1
            r2.reportServerError(r0, r3, r4)     // Catch:{ all -> 0x00ea }
        L_0x0079:
            java.util.Set<java.lang.String> r2 = replConnGroupLocks     // Catch:{ all -> 0x00ea }
            com.mysql.fabric.ServerGroup r3 = r5.serverGroup     // Catch:{ all -> 0x00ea }
            java.lang.String r3 = r3.getName()     // Catch:{ all -> 0x00ea }
            boolean r3 = r2.add(r3)     // Catch:{ all -> 0x00ea }
            if (r3 == 0) goto L_0x00e0
            com.mysql.fabric.FabricConnection r3 = r5.fabricConnection     // Catch:{ SQLException -> 0x00be }
            r3.refreshStatePassive()     // Catch:{ SQLException -> 0x00be }
            com.mysql.fabric.ServerGroup r3 = r5.serverGroup     // Catch:{ SQLException -> 0x00be }
            java.lang.String r3 = r3.getName()     // Catch:{ SQLException -> 0x00be }
            r5.setCurrentServerGroup(r3)     // Catch:{ SQLException -> 0x00be }
            com.mysql.jdbc.ReplicationConnectionGroup r3 = com.mysql.jdbc.ReplicationConnectionGroupManager.getConnectionGroup(r8)     // Catch:{ SQLException -> 0x00ac }
            r5.syncGroupServersToReplicationConnectionGroup(r3)     // Catch:{ SQLException -> 0x00ac }
            com.mysql.fabric.ServerGroup r3 = r5.serverGroup     // Catch:{ all -> 0x00ea }
            java.lang.String r3 = r3.getName()     // Catch:{ all -> 0x00ea }
            r2.remove(r3)     // Catch:{ all -> 0x00ea }
            monitor-exit(r5)
            return r1
        L_0x00ac:
            r1 = move-exception
        ...
        L_0x00be:
            r2 = move-exception
            java.lang.String r3 = "Unable to refresh Fabric state. Failover impossible"
            java.lang.String r4 = "08006"
            java.sql.SQLException r1 = com.mysql.jdbc.SQLError.createSQLException((java.lang.String) r3, (java.lang.String) r4, (java.lang.Throwable) r2, (com.mysql.jdbc.ExceptionInterceptor) r1)     // Catch:{ all -> 0x00bc }
            java.util.Set<java.lang.String> r3 = replConnGroupLocks     // Catch:{ all -> 0x00ea }
            com.mysql.fabric.ServerGroup r4 = r5.serverGroup     // Catch:{ all -> 0x00ea }
            java.lang.String r4 = r4.getName()     // Catch:{ all -> 0x00ea }
            r3.remove(r4)     // Catch:{ all -> 0x00ea }
            monitor-exit(r5)
            return r1
        L_0x00d4:
            java.util.Set<java.lang.String> r2 = replConnGroupLocks     // Catch:{ all -> 0x00ea }
        ...
        L_0x00e0:
            java.lang.String r2 = "Fabric state syncing already in progress in another thread."
            java.lang.String r3 = "08006"
            java.sql.SQLException r1 = com.mysql.jdbc.SQLError.createSQLException((java.lang.String) r2, (java.lang.String) r3, (java.lang.Throwable) r6, (com.mysql.jdbc.ExceptionInterceptor) r1)     // Catch:{ all -> 0x00ea }
            monitor-exit(r5)
            return r1
        L_0x00ea:
            r6 = move-exception
    ...
    private void refreshStateIfNecessary() throws SQLException {
        if (this.fabricConnection.isStateExpired()) {
            ...
            if (serverGroup2 != null) {
                setCurrentServerGroup(serverGroup2.getName());
            }
        }
    }

    public void setShardKey(String shardKey2) throws SQLException {
        ensureNoTransactionInProgress();
        this.currentConnection = null;
        if (shardKey2 != null) {
            if (this.serverGroupName != null) {
                throw SQLError.createSQLException("Shard key cannot be provided when server group is chosen directly.", SQLError.SQL_STATE_ILLEGAL_ARGUMENT, (Throwable) null, getExceptionInterceptor(), (Connection) this);
            } else if (this.shardTable != null) {
                setCurrentServerGroup(this.shardMapping.getGroupNameForKey(shardKey2));
            } else {
                throw SQLError.createSQLException("Shard key cannot be provided without a shard table.", SQLError.SQL_STATE_ILLEGAL_ARGUMENT, (Throwable) null, getExceptionInterceptor(), (Connection) this);
            }
        } else if (this.shardTable != null) {
            setCurrentServerGroup(this.shardMapping.getGlobalGroupName());
        }
        this.shardKey = shardKey2;
    }
    ...
    public void setShardTable(String shardTable2) throws SQLException {
        ensureNoTransactionInProgress();
        this.currentConnection = null;
        if (this.serverGroupName == null) {
            this.shardKey = null;
            this.serverGroup = null;
            this.shardTable = shardTable2;
            if (shardTable2 == null) {
                this.shardMapping = null;
                return;
            }
            String table = shardTable2;
            String db = this.database;
            if (shardTable2.contains(".")) {
                String[] pair = shardTable2.split("\\.");
                db = pair[0];
                table = pair[1];
            }
            ShardMapping shardMapping2 = this.fabricConnection.getShardMapping(db, table);
            this.shardMapping = shardMapping2;
            if (shardMapping2 != null) {
                setCurrentServerGroup(shardMapping2.getGlobalGroupName());
                return;
            }
            throw SQLError.createSQLException("Shard mapping not found for table `" + shardTable2 + "'", SQLError.SQL_STATE_ILLEGAL_ARGUMENT, (Throwable) null, getExceptionInterceptor(), (Connection) this);
        }
        throw SQLError.createSQLException("Server group and shard table are mutually exclusive. Only one may be provided.", SQLError.SQL_STATE_ILLEGAL_ARGUMENT, (Throwable) null, getExceptionInterceptor(), (Connection) this);
    }
    ...
    public void setServerGroupName(String serverGroupName2) throws SQLException {
        ensureNoTransactionInProgress();
        this.currentConnection = null;
        if (serverGroupName2 != null) {
            setCurrentServerGroup(serverGroupName2);
        }
        this.serverGroupName = serverGroupName2;
    }
    ...
    public void addQueryTable(String tableName) throws SQLException {
        ...
        if (this.shardMapping != null) {
            ...
            if (mappingForTableName != null && !mappingForTableName.equals(this.shardMapping)) {
                throw SQLError.createSQLException("Cross-shard query not allowed", SQLError.SQL_STATE_ILLEGAL_ARGUMENT, (Throwable) null, getExceptionInterceptor(), (Connection) this);
            }
    ...
    public void setCurrentServerGroup(String serverGroupName2) throws SQLException {
        ServerGroup serverGroup2 = this.fabricConnection.getServerGroup(serverGroupName2);
        this.serverGroup = serverGroup2;
        if (serverGroup2 != null) {
            ReplicationConnectionGroup replConnGroup = ReplicationConnectionGroupManager.getConnectionGroup(serverGroupName2);
            ...
            throw SQLError.createSQLException("Cannot find server group: `" + serverGroupName2 + "'", SQLError.SQL_STATE_ILLEGAL_ARGUMENT, (Throwable) null, getExceptionInterceptor(), (Connection) this);
        }
    }
    ...
    private void syncGroupServersToReplicationConnectionGroup(ReplicationConnectionGroup replConnGroup) throws SQLException {
        ...
        if (newMaster != null && replConnGroup.getMasterHosts().size() == 0) {
            ...
            try {
                ...
                throw SQLError.createSQLException("Unable to promote new master '" + newMaster.toString() + "'", ex2.getSQLState(), (Throwable) ex2, (ExceptionInterceptor) null);
            }
        }
    ...
    public Connection getActiveConnection() throws SQLException {
        ...
        if (getCurrentServerGroup() != null) {
            ...
            Properties info = exposeAsProperties((Properties) null);
            ...
            ReplicationConnection createProxyInstance = ReplicationConnectionProxy.createProxyInstance(masterHost, info, slaveHosts, info);
        ...
        throw SQLError.createSQLException("No server group selected.", SQLError.SQL_STATE_CONNECTION_REJECTED, (Throwable) null, getExceptionInterceptor(), (Connection) this);
    }
