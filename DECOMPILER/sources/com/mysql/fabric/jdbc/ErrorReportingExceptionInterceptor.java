...
public class ErrorReportingExceptionInterceptor implements ExceptionInterceptor {
    ...
    public SQLException interceptException(SQLException sqlEx, Connection conn) {
        ...
        try {
            ...
            return SQLError.createSQLException("Failed to report error to Fabric.", SQLError.SQL_STATE_COMMUNICATION_LINK_FAILURE, (Throwable) ex, (ExceptionInterceptor) null);
        }
    }
