...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x007d:
            ...
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01bb }
            int r2 = r1.getDimensionPixelSize(r2, r6)     // Catch:{ all -> 0x01bb }
            float r2 = (float) r2     // Catch:{ all -> 0x01bb }
            r10.tabTextSize = r2     // Catch:{ all -> 0x01bb }
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01bb }
            android.content.res.ColorStateList r2 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r1, (int) r2)     // Catch:{ all -> 0x01bb }
            r10.tabTextColors = r2     // Catch:{ all -> 0x01bb }
            r1.recycle()
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void jumpIndicatorToSelectedPosition() {
            View currentView = getChildAt(TabLayout.this.getSelectedTabPosition());
