...
final class ColorResourcesTableCreator {
    ...
    private static class StringPoolChunk {
        ...
        StringPoolChunk(boolean utf8, String... rawStrings) {
            ...
            this.chunkSize = i3;
            this.header = new ResChunkHeader(ColorResourcesTableCreator.HEADER_TYPE_STRING_POOL, HEADER_SIZE, i3);
        }
    ...
    public static byte[] shortToByteArray(short value) {
        return new byte[]{(byte) (value & Buffer.TYPE_ID_ERROR), (byte) ((value >> 8) & 255)};
    }
