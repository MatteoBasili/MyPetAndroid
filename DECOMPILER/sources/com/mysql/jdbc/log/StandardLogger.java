...
public class StandardLogger implements Log {
    ...
    public StandardLogger(String name, boolean logLocationInfo2) {
        this.logLocationInfo = true;
        this.logLocationInfo = logLocationInfo2;
    }
    ...
    public void logDebug(Object message) {
        logInternal(4, message, (Throwable) null);
    }
    ...
    public void logError(Object message) {
        logInternal(1, message, (Throwable) null);
    }
    ...
    public void logFatal(Object message) {
        logInternal(0, message, (Throwable) null);
    }
    ...
    public void logInfo(Object message) {
        logInternal(3, message, (Throwable) null);
    }
    ...
    public void logTrace(Object message) {
        logInternal(5, message, (Throwable) null);
    }
    ...
    public void logWarn(Object message) {
        logInternal(2, message, (Throwable) null);
    }
    ...
    public String logInternal(int level, Object msg, Throwable exception) {
        ...
        if (msg instanceof ProfilerEvent) {
            ...
            if (this.logLocationInfo && level != 5) {
                msgBuf.append(LogUtils.findCallingClassAndMethod(new Throwable()));
                msgBuf.append(" ");
            }
            if (msg != null) {
