...
public final class DelayKt {
    ...
    public static final Object m1650delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1651toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1651toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1485compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1588getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1504getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
