...
public final class FragmentFavoritesPetBinding implements ViewBinding {
    ...
    public final PetFavToolbarBinding toolbar;

    private FragmentFavoritesPetBinding(ConstraintLayout rootView2, ConstraintLayout constView2, ConstraintLayout intConstView2, ProgressBar loadProgressBar2, ListView petSitListView2, TextView subtitle2, TextView textNoFav2, TextView title2, PetFavToolbarBinding toolbar2) {
    ...
    public static FragmentFavoritesPetBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, (ViewGroup) null, false);
    }

    public static FragmentFavoritesPetBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(R.layout.fragment_favorites_pet, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static FragmentFavoritesPetBinding bind(View rootView2) {
        View view = rootView2;
                        ...
                        if (subtitle2 != null) {
                            ...
                            if (textNoFav2 != null) {
                                ...
                                if (title2 != null) {
                                    ...
                                    if (toolbar2 != null) {
                                        return new FragmentFavoritesPetBinding((ConstraintLayout) view, constView2, intConstView2, loadProgressBar2, petSitListView2, subtitle2, textNoFav2, title2, PetFavToolbarBinding.bind(toolbar2));
                                    }
                                }
                            }
                        }
