...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1480minusLRDsOJo(long duration) {
    ...
    public long m1478elapsedNowUwyO8pc() {
        return Duration.m1521minusLRDsOJo(this.mark.m1621elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1481plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1522plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
