...
import com.application.mypetandroid.services.profile.LoadFavPetSitPresenter;
...
public class FavoritesPetSitFragment extends Fragment implements ProfileContract.LoadFavPetView {
    ...
    private String user;
    private LoadFavPetSitPresenter loadFavPetSitPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        loadFavPetSitPresenter = new LoadFavPetSitPresenter(this);
    ...
    private void loadFavorites() {
        loadFavPetSitPresenter.loadFavorites(user);
    }
