...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageView3, @NonNull ImageView imageView7,
      @NonNull ConstraintLayout splashScreen, @NonNull TextView splashScreenTitle,
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout splashScreen = (ConstraintLayout) rootView;
      ...
      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, imageView3, imageView7,
          splashScreen, splashScreenTitle, textView2, textView4);
    }
