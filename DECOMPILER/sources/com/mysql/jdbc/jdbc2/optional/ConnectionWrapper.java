...
public class ConnectionWrapper extends WrapperBase implements Connection {
    ...
    public void setAutoCommit(boolean autoCommit) throws SQLException {
        ...
        if (!autoCommit || !isInGlobalTx()) {
            ...
            throw SQLError.createSQLException("Can't set autocommit to 'true' on an XAConnection", SQLError.SQL_STATE_INVALID_TRANSACTION_TERMINATION, (int) MysqlErrorNumbers.ER_XA_RMERR, this.exceptionInterceptor);
        }
    }
    ...
    public void commit() throws SQLException {
        ...
        if (!isInGlobalTx()) {
            ...
            throw SQLError.createSQLException("Can't call commit() on an XAConnection associated with a global transaction", SQLError.SQL_STATE_INVALID_TRANSACTION_TERMINATION, (int) MysqlErrorNumbers.ER_XA_RMERR, this.exceptionInterceptor);
        }
    }
    ...
    public void rollback() throws SQLException {
        ...
        if (!isInGlobalTx()) {
            ...
            throw SQLError.createSQLException("Can't call rollback() on an XAConnection associated with a global transaction", SQLError.SQL_STATE_INVALID_TRANSACTION_TERMINATION, (int) MysqlErrorNumbers.ER_XA_RMERR, this.exceptionInterceptor);
        }
    }
    ...
    public void close(boolean fireClosedEvent) throws SQLException {
