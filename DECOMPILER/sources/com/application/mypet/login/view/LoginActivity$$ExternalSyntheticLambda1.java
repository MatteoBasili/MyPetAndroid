...
public final /* synthetic */ class LoginActivity$$ExternalSyntheticLambda1 implements View.OnClickListener {
    ...
    public /* synthetic */ LoginActivity$$ExternalSyntheticLambda1(EditText editText, ImageView imageView, ImageView imageView2) {
        this.f$0 = editText;
        this.f$1 = imageView;
        this.f$2 = imageView2;
    }
    ...
    public final void onClick(View view) {
        LoginActivity.lambda$onCreate$1(this.f$0, this.f$1, this.f$2, view);
    }
}
