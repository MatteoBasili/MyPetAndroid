...
public interface TimeMark {
    ...
    TimeMark m1622minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1623plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1624minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m1623plusLRDsOJo(Duration.m1538unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1519isNegativeimpl($this.m1621elapsedNowUwyO8pc());
        }
